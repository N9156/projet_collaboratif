    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light mb-5">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-item nav-link" href="gestion_produits.php">Gestion des produits</a>
                <a class="nav-item nav-link" href="gestion_commandes.php">Gestion des commandes</a>
                <a class="nav-item nav-link" href="gestion_clients.php">Gestion des clients</a>
